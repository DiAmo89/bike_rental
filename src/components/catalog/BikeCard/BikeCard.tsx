...
<div className="border rounded-lg shadow-md overflow-hidden bg-white flex flex-col h-full">
  ...
  <div className="p-4 flex flex-col flex-grow">
    <p className="text-xs text-blue-500 font-bold uppercase tracking-wider">{bike.category.name}</p>
    <h3 className="text-lg font-bold mt-1 text-gray-900 line-clamp-1">{bike.model}</h3>
    ...
    <div className="mt-4 pt-4 border-t border-gray-100 flex items-center justify-between">
      <div className="flex flex-col">
           <span className="text-xl font-black text-gray-900">${bike.price}<span className="text-xs text-gray-400">/Hour</span></span>
      </div>
