...
if (!bike) return <div className="p-20 text-center font-bold">Loading...</div>;
...
<p className="text-3xl font-black text-gray-900 mb-8">{bike.price} ₽ / час</p>
...
<span className="bg-gray-100 p-2 rounded text-sm">🛠 Available: {bike.status}</span>
</div>
</div>
